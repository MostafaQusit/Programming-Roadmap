...
1. [**ITI: C++ OOP Course - Google Drive**](https://drive.google.com/drive/folders/1p_KpAUZ9m5SpBmxywfnVxZbEcXZ-kgT7?usp=drive_link)

2. [**C++ OOP Course by Dr. Al-Desouki**](https://youtube.com/playlist?list=PL1DUmTEdeA6KLEvIO0NyrkT91BVle8BOU&si=jPW8fjvGX1S0HJHL)

**I case of enroll in .NET**
   - **C# Syntax Overview**
...
4. [**ITI: C++ Data Structures Lectures by Eng. Ahmed Mamdouh - Google Drive**](https://drive.google.com/drive/folders/1p6BVDUR8Pzjxs0q2iuxiXF95eiK5oRKp?usp=drive_link)
   - _need to see one of the previous points_

5. [**FreeCodeCamp: C/C++ Data Structures Course**](https://youtu.be/B31LgI4Y4DQ?si=EokHSvAyeYnwXY0z)
...
### **Step 9: Command Line and Version Control**
...
3. **Git and Version Control**:
   - [**Git Course by Ahmed Samy**](https://youtu.be/Q6G-J54vgKc?si=qjyX-25ySQ46IFjO)
   - [**ITI: Git Course - Google Drive**](https://drive.google.com/drive/folders/15GnZ4GEKXxzRzp4L95cbNLLt0pMsXgE7?usp=drive_link)
   - **SuperSimpleDev: Git and GitHub Course**
...
1. **Database Resources**  
   [Explore This Post for Resources](https://www.facebook.com/permalink.php...)

2. **Dr. Al-Desouki's Database Course**  
   - **Theoretical Part**:  
     [Watch the Playlist](https://www.youtube.com/playlist...)
   - **Practical Part**:  
     [Watch the Playlist](https://www.youtube.com/playlist...)

3. **Database Course by Adel Nassim**  
   [Watch the Playlist](https://www.youtube.com/playlist...)

4. **FreeCodeCamp MySQL Course**  
   [Watch the Video](https://youtu.be/7S_tz1z_5bA)


### **Step 11: Web Development Basics**

1. **HTML & CSS**:
   - **Front-End Web Development by Eng. Mostafa Saad**  
     [Watch the Playlist](https://www.youtube.com/playlist...)
...
3. **Node.js**:
   - **Node.js by Hussein Nasser**  
     [Watch the Playlist](https://www.youtube.com/playlist...)

### **Step 12: Databases**

1. **MySQL Database**:
   - **FreeCodeCamp's MySQL Course**  
     [Watch the Video](https://youtu.be/7S_tz1z_5bA)

2. **Oracle Database**:
   - **Oracle 12C by Eng. Ahmed Ragab**  
     [Watch the Playlist](https://www.youtube.com/playlist...)
